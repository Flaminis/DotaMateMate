...
class TimerViewController: UIViewController {
    ...
    override func viewDidLayoutSubviews() {
        ...
        if progressRingView?.superview != nil { return }
        ...
        TimerView.sendSubviewToBack(progressRingView)
    ...
    func animateCircle(indexCircle: Int, toThePoint: CGFloat,amountOfTime: CGFloat){
    ...
    func rateApp(){
        ...
        UIApplication.sharedApplication().openURL(NSURL(string : "https://itunes.apple.com/us/app/dotamate-dota-2-guides-builds/id1137556608?ls=1&mt=8")!)
